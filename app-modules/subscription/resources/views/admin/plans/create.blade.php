    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Create Subscription Plan</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Add a new subscription plan with multilingual support</p>
                </div>
        ...
        <div class="p-6">
            <form action="{{ route('subscription::admin.plans.store') }}" method="POST" class="space-y-6">
                @csrf
                    ...
                    <div id="features-tab-en" class="features-tab-panel">
                        <div>
                            ...
                            <textarea id="features_en"
                                      ...
                                      rows="8"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="List plan features in English (supports Markdown)">{{ old('features.en') }}</textarea>
                            @error('features.en')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div id="features-tab-bn" class="features-tab-panel hidden">
                        <div>
                            ...
                            <textarea id="features_bn"
                                      ...
                                      rows="8"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="বাংলায় প্ল্যানের ফিচার লিস্ট (Markdown সাপোর্ট করে)">{{ old('features.bn') }}</textarea>
                            @error('features.bn')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
