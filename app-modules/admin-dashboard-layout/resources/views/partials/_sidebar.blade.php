        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <!-- Support Tickets -->
                    <a href="{{ route('support-ticket::admin.tickets.index') }}" 
                       class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-colors {{ request()->routeIs('support-ticket::admin.tickets.*') ? 'bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
