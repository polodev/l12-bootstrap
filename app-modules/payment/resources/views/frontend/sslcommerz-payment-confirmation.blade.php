                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-900 dark:text-gray-100">{{ __('messages.online_payment_sslcommerz') }}</div>
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Gateway Payment ID</label>
                            <div class="text-sm font-mono text-gray-900 dark:text-gray-100">{{ $payment->gateway_payment_id }}</div>
                        </div>
                        @endif
                        @if($payment->gateway_reference)
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Bank Transaction ID</label>
                            <div class="text-sm font-mono text-gray-900 dark:text-gray-100">{{ $payment->gateway_reference }}</div>
                        </div>
                        @endif
                        <div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200">Payment processed via SSLCommerz</h3>
                                    <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                        <p>{{ __('messages.secure_payment_powered_by') }} SSLCommerz - Bangladesh's leading payment gateway.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
