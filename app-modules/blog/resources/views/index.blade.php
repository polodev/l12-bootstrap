    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Blog Management</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Create and manage blog posts</p>
                </div>
            ...
            <div id="filter_area" class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-3" style="display: block;">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div>
                        <label for="tag_id" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Filter by Tag</label>
                        <select class="w-full px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" name="tag_id" id="tag_id">
                    ...
                    <div>
                        ...
                        <input class="w-full px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" type="text" name="search_text" id="search_text" placeholder="Search by title, slug, content...">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-hidden">
            <table id="blog-table" class="w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            var blogTable = $('#blog-table').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: 'Slug',
                        searchable: true,
                        className: 'font-mono text-sm min-w-32'
                    },
                    {
                        data: 'status_badge',
                        name: 'status',
                ...
                drawCallback: function() {
                    ...
                    $('#blog-table').addClass('divide-y divide-gray-200 dark:divide-gray-700');
                    $('#blog-table thead').addClass('bg-gray-50 dark:bg-gray-700');
                    $('#blog-table thead th').addClass('px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider');
                    $('#blog-table tbody').addClass('bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700');
                    $('#blog-table tbody td').addClass('px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100');
                    
                    // Fix column alignment after draw
                    setTimeout(function() {
                        blogTable.columns.adjust();
                    }, 100);
                }
            });
            
            // Filter change listeners
            var filterElements = ['#status', '#tag_id'];
